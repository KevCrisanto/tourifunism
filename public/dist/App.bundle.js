...
var mapOptions = {
  center: { lat: 34.13, lng: -118.35 },
  zoom: 10
};

function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 34.13;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -118.35;

  _axios2.default.get('/api/attractions/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    var places = res.data;
    if (!places.length) {
    ...
    markers.forEach(function (marker) {
      return marker.addListener('click', function () {
        var html = '\n          <div class="popup">\n            <a href="/attraction/' + this.place.slug + '">\n              <img src="/uploads/' + (this.place.photo || 'attraction.png') + '" alt="' + this.place.name + '"/>\n              <p>' + this.place.name + ' - ' + this.place.location.address + '</p>\n            </a>\n          </div>\n        ';
    ...
    map.setCenter(bounds.getCenter()); // center markers
